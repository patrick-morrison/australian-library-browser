# Preview Scope Debug 1775100974253

This is a self-describing research package.

## Structure

- `preview-scope-debug-1775100974253.trovelibrary`: project metadata, saved items, ignored items, uncollected items, and source aliases.
...
- `preview-scope-debug-1775100974253.trovelibrary` is the inventory and source map for the package.
...
- Coding agents can read `preview-scope-debug-1775100974253.trovelibrary` plus the markdown files directly.
