# Preview Drift Debug 1775101010607

This is a self-describing research package.

## Structure

- `preview-drift-debug-1775101010607.trovelibrary`: project metadata, saved items, ignored items, uncollected items, and source aliases.
...
- `preview-drift-debug-1775101010607.trovelibrary` is the inventory and source map for the package.
...
- Coding agents can read `preview-drift-debug-1775101010607.trovelibrary` plus the markdown files directly.
