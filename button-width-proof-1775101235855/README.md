# Button Width Proof 1775101235855

This is a self-describing research package.

## Structure

- `button-width-proof-1775101235855.trovelibrary`: project metadata, saved items, ignored items, uncollected items, and source aliases.
...
- `button-width-proof-1775101235855.trovelibrary` is the inventory and source map for the package.
...
- Coding agents can read `button-width-proof-1775101235855.trovelibrary` plus the markdown files directly.
